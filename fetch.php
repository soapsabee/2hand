...
echo'<img class="card-img-top" style="width:auto; height:250px;" src="product_img/'.$result['IMG_HEAD'].'"alt="Card image">';
echo'<div class="card-body">';
echo'<h4 class="card-title">'.$result['Product_Name'].'</h4>';
echo'<p class="card-text">'.$result['Product_Locate'].'</p>';
echo'<p class="card-text">'.$result['Product_Price'].'</p>';
echo'<a href="page_product.php?productid='.$result['Product_ID'].'class="btn btn-primary">See Profile</a>';
echo'</div>';
echo '</div>';
