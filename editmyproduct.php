...
echo '<td>';
			   ...
			   echo '</td>';
               echo '<td>';
               echo "<textarea rows='3' cols='55' name='address' required>"."$row[Product_Info]"."</textarea>".'<br>';
               echo '</td>';
echo '</tr>';
echo '<tr>';
echo '<td>';
...
<button type="button" class="btn btn-link" onClick = "window.location ='myproduct.php'">ย้อนกลับ</button>
</form>
    <!-- Optional JavaScript -->
