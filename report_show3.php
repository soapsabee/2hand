...
<html lang="en">
 ...
 if(isset($_POST['province']) && isset($_POST['month'])){
     ...
     $sql = "SELECT Product_Type,COUNT(*) AS 'Count' FROM user INNER JOIN product ON user.username=product.User_Name 
     WHERE Product_Date LIKE '%-$month-%' AND Product_Locate LIKE '$province' GROUP BY Product_Type";
